...
filename="${COMMUNIS_PATH}/Deploy_store/.qa/main_repo_fn/dir_bash_/_bash_/_man/eval/name_fn_from_variable.sh"
...
a_fn(){
    echo -e "${BLUE}--- start ${FUNCNAME[0]}() ---${NORMAL}" #sistem info mesage
}
